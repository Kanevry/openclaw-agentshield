...
- 130+ Detection Patterns (142 total primitives): Base64 + Hex + Unicode + Typoglycemia + HTML Exfiltration + System Prompt Extraction + ROT13 + Markdown Exfil + SSRF + Path Traversal + 22 API Key Patterns
