...
- **180+ detection patterns** across 16 categories, with base64, hex, and ROT13 decoding as pre-processing layers. The scanner catches attacks that bypass simple string matching.
